...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Dashboard Edit Movies</h1>
  ...
  <div class="container-lg mt-4 ">
     <div class="align-middle bg-light pt-4">
         <h4 class="text-center fw-bold text-primary"> Edit movie</h4>
         <h3 class="mb-5 text-center text-warning fw-bold "></h3>
     <form class="align-middle row g-3">    
      
      <div class="mb-3 row">
      <label for="title" class="col-sm-2 col-form-label">Movie Title</label> 
   <div class="col-sm-10"> <input type="text"  class="form-control" id="mTitle" placeholder="enter movie title"> 
   </div> </div> 
         <div class="mb-3 row">
      <label for="rname" class="col-sm-2 col-form-label">Release Date</label> 
   <div class="col-sm-10"> <input type="date"  class="form-control" id="release-date" placeholder="enter release date"> 
   </div> </div> 
   <div class="mb-3 row"> 
   <label for="director" class="col-sm-2 col-form-label">Director </label> 
   <div class="col-sm-10"> <input type="text"  class="form-control" id="director" placeholder="enter Director's name"> 
   </div> </div> 
   <!-- <div class="dropdown " >
...
<div class="mb-3 row"> 
  ...
  <option value="1">Ronantic-comedy</option>
  ...
  <option value="3">Drama</option>
   ...
   <div class="col-sm-10"> <input type="text"  class="form-control" id="duration" placeholder="enter movie's length in hours "> 
   </div> </div> 
   
   <div class="mb-3 row"> 
       <label for="trailerlink" class="col-sm-2 col-form-label">Trailer link</label> 
       <div class=" col-sm-10"> <input type="url" class="form-control" id="trailerlink"  placeholder="traler's youtube link " required>
        </div>
        </div>
        <div class="mb-3 row"> 
       <label for="movieposture" class="col-sm-2 col-form-label">Movie posture</label> 
       <div class="mb-5 col-sm-10">  <input type="file" class="form-control" id="filmPhoto"  name="filmPhoto" accept="image/*" required>
        </div>
        </div>
        <div class="mb-3">
   ...
   <div class="row">
      ...
      <div class=" col-auto "> <button type="submit" class="btn btn-primary mb-3 ">Save changes </button> </div>
