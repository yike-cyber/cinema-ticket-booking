...
<!-- font awesome link -->
<script src="https://kit.fontawesome.com/116c95c2d6.js" crossorigin="anonymous"></script>
    <title>Delete</title>
</head>
<body>
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3  ms-5 col-lg-2 me-0 px-3 fs-6" href="#" text-primary>Admin pannel</a>
  <input class="  mb-form-control form-control-dark  col-lg-6 " type="search" placeholder="Search" aria-label="Search">
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./deposit-balance.html">
        ...
        <ul class="nav flex-column mb-2">
          <li class="nav-item">
            <a class="nav-link" href="./allMovies.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./delete-movie.html">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text align-text-bottom" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
             Remove a movie
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./edit-movie.html">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text align-text-bottom" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
              Edit a movie
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./upload-movie.html">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
            <path fill=" none" d="M0 0h24v24H0z"/>
            <path d="M16.5 6H8.7l-.6-1.4C7.9 4.2 7.4 4 6.8 4H4.5C3.7 4 3 4.7 3 5.5v13c0 .8.7 1.5 1.5 1.5h15c.8 0 1.5-.7 1.5-1.5v-9c0-.8-.7-1.5-1.5-1.5h-2.8l-1.2-3zM12 16l-4-4h3V9h2v3h3l-4 4z"/>
              </svg>
              Delete a movie
            </a>
          </li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Dashboard Delete Movies</h1>
